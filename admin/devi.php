        ...
        <main>
            <div class="container-fluid px-4">
                <div class="card mb-4">
                    ...
                    <form action="insertdeli.php" method="POST">
                    ...
                    <br>
                        <br>
                            <div class="from-group">
                                <label for="">เลขพัสดุ</label>
                                <input type = "text" name = "track_num" class = "form-control">
                            </div>
                            <br>
                            <div class="input-group mb-3">
                                <label class="input-group-text" for="inputGroupSelect01">Options</label>
                                <select class="form-select" name="status_deli" id="inputGroupSelect01" required>
                                    <option  value="">Choose...</option>
                                    <option  value="1" >กำลังจัดเตรียมพัสดุ</option>
                                    <option value="0" >อยู่ระหว่างการดำเนินการ</option>
                                    <option value="2" >ส่งพัสดุแล้ว</option>
                                </select>
                                <br>
                            </div>
                             <br>
                            <div class="from-group">
                                <label for="">ออเดอร์</label>
                                <input type = "text" name = "order_id" class = "form-control" value="<?php echo $order_id;?>">
                            </div>
                            <br><br>
                            <label for="">บริษัทขนส่ง</label>
                            <div class="input-group mb-3">
                                
                                <label class="input-group-text" for="inputGroupSelect01">Options</label>
                                <select class="form-select" name="delivery_code" id="inputGroupSelect01" required>
                                    <option  value="">Choose...</option>
