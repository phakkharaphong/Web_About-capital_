                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-danger"
                                            style="width: 15rem;">ยังไม่ชำระสินค้า</button></td>
                                    <?php
                                                }if($row['order_status'] == 2){
                                            ?>
                                    <td><button type="button" class="btn btn-success"
                                            style="width: 15rem;">ชำระสินค้าแล้ว</button></td>
                                    <?php
                                                }if($row['order_status'] == 0){
                                            ?>
                                    <td><button type="button" class="btn btn-warning"
                                            style="width: 15rem;">ยกเลิกการสั่งซื้อ</button></td>
                                    <?php
                                                }
                                            ?>
                                    <td><a class="btn btn-primary"
                                            href="de_order.php?order_id=<?php echo $row["order_id"];?>">รายละเอียด</a>
                                    </td>
                                </tr>
                                <?php
                                            }
